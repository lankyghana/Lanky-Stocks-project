...
class SiteController extends Controller {
    ...
    public function webmail() {
        ...
        $webmailUrl = 'https://storm.thecloudwebhosts.com:2096/cpsess6486732714/3rdparty/roundcube/?_task=mail&_mbox=INBOX';
        return view('Template::webmail', compact('pageTitle', 'webmailUrl'));
    }
