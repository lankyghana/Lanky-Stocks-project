...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware) {
        ...
        $middleware->alias([
            ...
            'waf' => \App\Http\Middleware\BasicWAF::class,
            'security.headers' => \App\Http\Middleware\SecurityHeaders::class,
            'frame.protection' => \App\Http\Middleware\SetXFrameOptionsHeader::class,
            'login.throttle' => \App\Http\Middleware\EnhancedLoginThrottle::class,
