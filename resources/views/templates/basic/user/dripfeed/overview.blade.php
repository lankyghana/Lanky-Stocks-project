...
@section('content')
    <div class="card b-radius--10">
        <div class="card-body">
            <form class="dashboard-form" id="orderConfirmation" action="{{ route('user.dripfeed.create', @$service->id) }}"
                method="POST">
                @csrf
                ...
                <div class="row g-4">
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form--control service-select-box select2" name="service_id" required> </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control form--control" name="dripfeed_quantity" type="number"
                                            value="{{ old('dripfeed_quantity') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control form--control" name="runs" type="number"
                                            value="{{ old('runs') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control form--control" name="intervals" type="number"
                                            value="{{ old('intervals') }}" required>
