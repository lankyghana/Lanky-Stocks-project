            ...
            <form class="dashboard-form" action="{{ route('ticket.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form--control select2" data-minimum-results-for-search="-1" name="priority" required>
                    ...
                    <div class="col-md-3">
                        <button class="btn btn--base w-100 h-45" type="submit"><i class="las la-paper-plane"></i> @lang('Submit')
                        </button>
                    </div>
                </div>
            </form>
